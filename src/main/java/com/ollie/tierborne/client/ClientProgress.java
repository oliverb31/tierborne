...
public final class ClientProgress {
 private static String playerClassId="",selectedAlternateAttack=""; private static int skillPoints; private static Set<String> unlockedSkills=Set.of(); private static boolean selectionPromptPending; private ClientProgress(){}
 public static void receive(SyncProgressPacket p){playerClassId=p.playerClassId();skillPoints=p.skillPoints();unlockedSkills=Set.copyOf(p.unlockedSkills());selectedAlternateAttack=p.selectedAlternateAttack();selectionPromptPending=playerClassId.isEmpty();tryOpenSelectionScreen();}
