...
public final class FireballRenderer extends EntityRenderer<FireballProjectile> {
    private static final ResourceLocation MODEL = resource(
            "models/vfx/awakened_mage/sorcery_combo/fireball/fireball.bbmodel");
    private static final ResourceLocation TEXTURE = resource(
            "textures/vfx/awakened_mage/sorcery_combo/fireball/fireball.png");
    ...
    @Override
    public void render(FireballProjectile projectile, float entityYaw, float partialTick,
        ...
        String animation = projectile.getVfxStyle() == 0
                ? "animation" : "animation" + (projectile.getVfxStyle() + 1);
