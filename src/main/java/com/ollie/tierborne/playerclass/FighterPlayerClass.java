...
public final class FighterPlayerClass extends PlayerClass {
    ...
    public static final String MONK_MOVE="fighter_monk_move",MONK_FIST="fighter_monk_fist",PULL="fighter_pull",MONK="fighter_subclass_monk",PULL_RECOVERY="monk_pull_recovery",EXTENDED_PULL="monk_extended_pull",MONK_FIST_UPGRADE="monk_fist_upgrade",UPPERCUT="monk_uppercut";
