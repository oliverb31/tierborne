...
public final class SwordsmanPlayerClass extends PlayerClass {
    ...
    public static final String ELEMENTAL_VULNERABILITY="magic_elemental_vulnerability", FIREBALL_COOLDOWN="magic_fireball_cooldown", FIREBALL_CHARGE="magic_fireball_charge", HOMING_FIREBALL="magic_homing_fireball";
    public static final String FIREBALL_SPEED_I="magic_fireball_speed_1", FIREBALL_SPEED_II="magic_fireball_speed_2", FIREBALL_DAMAGE_I="magic_fireball_damage_1", FIREBALL_DAMAGE_II="magic_fireball_damage_2", ADDITIONAL_FIREBALL="magic_additional_fireball";
    ...
    private static final List<Skill> SKILLS=List.of(
        ...
        alt(MULTISLASH,"Multislash","Perform two fully charged strikes with one sword or four alternating strikes with two swords.",Items.IRON_SWORD,-2,8,MOVE_SPEED_2),
        ...
        node(HOMING_FIREBALL,"Homing Fireball","Fully charged Fireballs can be guided while C remains held.",Items.ENDER_EYE,9,4,List.of(FIREBALL_SPEED_II,FIREBALL_CHARGE,FIREBALL_DAMAGE_II)),
        node(ADDITIONAL_FIREBALL,"Additional Fireball","Raises the maximum Homing Fireball group size.",Items.FIRE_CHARGE,10,4,HOMING_FIREBALL)
    );
